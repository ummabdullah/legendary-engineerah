...
{   
    static void removeDuplicates(int[] arrayWithDuplicates)
    {
        ...
        for (int i = 0; i < noOfUniqueElements; i++) 
        {
            for (int j = i+1; j < noOfUniqueElements; j++)
            {
                ...
                if (arrayWithDuplicates[i]<0)
                {	arrayWithDuplicates[i]= arrayWithDuplicates[noOfUniqueElements-1];
                	noOfUniqueElements--;
                	
                }
                else if(arrayWithDuplicates[i] == arrayWithDuplicates[j])
                {
                    ...
                    //since its been copied over and 
                    //no longer needed at the end of array
    ...
    {       
        ...
        removeDuplicates(new int[] {-7, 3, -21, 7, 34, 18, -3, 21,0,0});
